package com.cinefile.reservationsite.config;

import com.cinefile.reservationsite.security.JwtAuthFilter;
        ...
        return http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            response.getWriter().write("{\"message\":\"Brak autoryzacji. Zaloguj się (401).\"}");
                        })

                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            response.setStatus(HttpServletResponse.SC_FORBIDDEN); // 403
                            response.setContentType("application/json;charset=UTF-8");
                            response.getWriter().write("{\"message\":\"Odmowa dostępu. Zbyt niska rola (403).\"}");
                        })
                )
